...
class VisitAgainCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool isPharmacy = Get.find<SplashController>().module != null && Get.find<SplashController>().module!.moduleType.toString() == AppConstants.pharmacy;
    ...
    final bool isAvailable = store.open == 1 && store.active!;
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: CustomImage(
                                image: '${store.items![index].imageFullUrl}', height: 25, width: 25,
                              ),
                            ),
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  children: [
                    CustomImage(
                      isHovered: hovered,
                      image: '${store.logoFullUrl}', height: 54, width: 54,
                    ),

                    isAvailable ? const SizedBox() : NotAvailableWidget(isStore: true, store: store, fontSize: 8),
