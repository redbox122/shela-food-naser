              ...
              child: Row(children: [
                SizedBox(
                  ...
                  child: AddressHelper.getUserAddressFromSharedPref() != null
                      ? InkWell(
                          onTap: () => Get.find<LocationController>().navigateToLocationScreen(context, 'home'),
                          child: Padding(
                ...
                GetBuilder<LocalizationController>(builder: (localizationController) {
                  final List<DropdownItem<int>> languageList = [];
                  final List<DropdownItem<int>> joinUsList = [];
                        ...
                        child: Row(
                          children: [
                            SizedBox(
                                height: 15,
                                width: 15,
                                child: Image.asset(AppConstants.languages[localizationController.selectedLanguageIndex].imageUrl!)),
                            Padding(
