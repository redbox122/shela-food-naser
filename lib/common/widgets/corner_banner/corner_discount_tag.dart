...
class CornerDiscountTag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (isPositioned) {
      ...
      // ⚡ FIX: Handle null discount and freeDelivery safely
      final hasDiscount = (discount ?? 0) > 0;
      final hasFreeDelivery = freeDelivery ?? false;
      return (hasDiscount || hasFreeDelivery) ? CornerBanner(
        bannerPosition: bannerPosition,
        bannerColor: Theme.of(context).colorScheme.error,
        elevation: 5,
        ...
        child: Row(
          ...
          children: [
            Column(
              ...
              children:  [
                Text(
                  // ⚡ FIX: Handle null discount safely
                  (discount ?? 0) > 0 
                  ...
                  style: robotoMedium.copyWith(
                    color: Colors.white,
                    fontSize: fontSize ?? (Get.context != null && ResponsiveHelper.isMobile(Get.context!) ? 8 : 12),
                  ),
