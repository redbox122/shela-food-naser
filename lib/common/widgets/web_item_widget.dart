...
class WebItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!isStore && item!.genericName != null && item!.genericName!.isNotEmpty) {
      for (final String name in item!.genericName!) {
        genericName += name;
      }
    }
    if (isStore) {
      ...
      isAvailable = store!.isOpen == true && store!.active!;
    } else {
                    ...
                    Stack(children: [
                      ClipRRect(
                        borderRadius: const BorderRadius.only(
                            topLeft: Radius.circular(Dimensions.radiusSmall), topRight: Radius.circular(Dimensions.radiusSmall)),
                        child: CustomImage(
                          isHovered: hovered,
                          image: isStore ? (store?.logoFullUrl ?? '') : (item?.displayImage ?? ''),
                          height: desktop
                              ? 140
                              : length == null
                                  ? 100
                      ...
                      !isStore ? OrganicTag(item: item!) : const SizedBox(),
                      isStore
                          ? const SizedBox()
                          : Positioned(
                              bottom: 10,
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                (isStore ? store!.address != null : item!.storeName != null)
                                    ...
                                    : const SizedBox(),
                                SizedBox(
                                    height: ((desktop || isStore) && (isStore ? store!.address != null : item!.storeName != null))
                                        ? 5
                                        : 0),
                                isStore
                                    ? RatingBar(
                                    ...
                                    : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                        Row(
                                          ...
                                          children: [
                                            discount! > 0 && item!.originalPrice != null
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                ...
                                                style: robotoRegular.copyWith(
                                                    fontSize: Dimensions.fontSizeOverSmall, color: Theme.of(context).primaryColor),
                                              ),
                                            ],
                                          ),
                                        )
