...
class CustomValidator {
  static Future<PhoneValid> isPhoneValid(String number) async {
    ...
    if (normalized.isEmpty) {
      return PhoneValid(isValid: false, countryCode: '', phone: '');
    }

    final parseTarget = normalized.startsWith('+')
        ? normalized
    ...
    try {
      final PhoneNumber phoneNumber = PhoneNumber.parse(parseTarget);
  ...
  static bool isEmailValid(String email) {
    ...
    final bool isValid = kEmailValid.hasMatch(email.toString());
    return isValid;
  }
}
