  ...
  Widget build(BuildContext context) {
    return GetBuilder<BannerController>(builder: (bannerController) {
      ...
      return Padding(
        ...
        child: bannerController.promotionalBanner != null ? InkWell(
          onTap: () async {
          ...
          child: Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
              child: CustomImage(
                image: '${bannerController.promotionalBanner!.bottomSectionBannerFullUrl}', height: 235, width: double.infinity,
              ),
            ),
          ),
