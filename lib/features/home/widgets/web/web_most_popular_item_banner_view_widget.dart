...
class WebMostPopularItemBannerViewWidget extends StatelessWidget {
            ...
            children: [
              ...
              PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final bool hasSecond = index2 < campaignController.basicCampaignList!.length;
                      ...
                      builder: (hovered) {
                        return InkWell(
                          ...
                          child: ClipRRect(
                            ...
                            child: CustomImage(
                              isHovered: hovered,
                              image: '${campaignController.basicCampaignList![index1].imageFullUrl}', height: 220,
                            ),
                          ),
                        );
                      }
              ...
              builder: (context) {
                ...
                return Row(
                  ...
                  children: finalBanner.map((bnr) {
                    final int index = finalBanner.indexOf(bnr);
                    return Padding(
  ...
  void _onTap(int index, BuildContext context) async {
    final BasicCampaignModel campaign = campaignController.basicCampaignList![index];
