...
class CategoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SplashController>(builder: (splashController) {
      final bool isPharmacy = splashController.module != null && splashController.module!.moduleType.toString() == 'pharmacy';
      final bool isFood = splashController.module != null && splashController.module!.moduleType.toString() == 'food';

      return GetBuilder<CategoryController>(builder: (categoryController) {
        categoryController.logRenderCategoryCount(
          contextLabel: isPharmacy
              ? 'home_pharmacy'
              : isFood
                  ? 'home_food'
                  : 'home_default',
          hardCap: isPharmacy || isFood ? null : 15,
        );
                                  ...
                                  child: categoryController.categoryList != null
                                      ? ListView.builder(
                                          ...
                                          padding: const EdgeInsets.only(
                                              left: Dimensions.paddingSizeSmall, top: Dimensions.paddingSizeDefault),
                                          physics: const BouncingScrollPhysics(),
                                          scrollDirection: Axis.horizontal,
                                          itemBuilder: (context, index) {
                                            return Padding(
                                              padding:
                                                  const EdgeInsets.symmetric(horizontal: 1, vertical: Dimensions.paddingSizeDefault),
                                              child: InkWell(
                                                onTap: () => Get.toNamed(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Column(children: [
                                                    ...
                                                    Padding(
                                                      padding:
                                                          EdgeInsets.only(right: index == 0 ? Dimensions.paddingSizeExtraSmall : 0),
                                                      child: Text(
                                                        categoryController.categoryList![index].name!,
