          ...
          ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Row(
                ...
                children: advertisementController.advertisementList!.map((advertisement) {
                  final int index = advertisementController.advertisementList!.indexOf(advertisement);
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return SizedBox(
                      width:
                          ResponsiveHelper.isDesktop(context) ? (Dimensions.webMaxWidth - 20) / 3 : MediaQuery.of(context).size.width,
                      child: Stack(
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            padding: const EdgeInsets.symmetric(
                                                horizontal: Dimensions.paddingSizeSmall + 5, vertical: Dimensions.paddingSizeSmall),
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                                              color: Theme.of(context).shadowColor,
                                            ),
