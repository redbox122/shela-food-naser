...
class PopularItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ItemController>(builder: (itemController) {
      final List<Item>? itemList = isPopular ? itemController.popularItemList : itemController.reviewedItemList;
                                  ...
                                  children: [
                                            ...
                                            Stack(children: [
                                              ClipRRect(
                                                ...
                                                child: CustomImage(
                                                  ...
                                                  fallbackUrls: itemList[index].imagesFullUrl,
                                                  imageStatus: itemList[index].imageStatus,
                                                  height: 80,
                                                  width: 80,
                                                ),
                                              ),
                                                    ...
                                                    children: [
                                                      Wrap(children: [
                                                        ...
                                                        (Get.find<SplashController>().configModel!.moduleConfig!.module!.vegNonVeg! &&
                                                            ...
                                                            ? Image.asset(
                                                                itemList[index].veg == 0 ? Images.nonVegImage : Images.vegImage,
                                                                height: 10,
                                                                width: 10,
                                                                fit: BoxFit.contain)
                                                            : const SizedBox(),
                                    ...
                                    Positioned(
                                      ...
                                      child: CornerDiscountTag(
                                        bannerPosition: Get.find<LocalizationController>().isLtr
