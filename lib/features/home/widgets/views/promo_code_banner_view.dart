    ...
    return GetBuilder<CouponController>(builder: (couponController) {
      return couponController.couponList != null
          ? couponController.couponList!.isNotEmpty
              ? Padding(
                  padding:
                      const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeDefault, horizontal: Dimensions.paddingSizeSmall),
                  child: Column(children: [
                                  ...
                                  children: [
                                    Text.rich(
                                      TextSpan(
                                        children: [
                                          TextSpan(
                                            text: couponController.couponList![itemIndex].title ?? '',
                                          ...
                                          WidgetSpan(
                                            child: PriceConverter.convertPrice2(
                                              couponController.couponList![itemIndex].minPurchase,
                                    ...
                                    DottedBorder(
                                      ...
                                      child: Container(
                                        ...
                                        decoration:
                                            BoxDecoration(color: Theme.of(context).cardColor, borderRadius: BorderRadius.circular(50)),
                                        child: CustomInkWell(
                                          onTap: () {
                    ...
                    Row(
                      ...
                      children: couponController.couponList!.map((bnr) {
                        final int index = couponController.couponList!.indexOf(bnr);
