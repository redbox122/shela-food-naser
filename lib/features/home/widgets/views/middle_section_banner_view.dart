        ...
        child: Column(children: [
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(Dimensions.radiusLarge),
                      child: CustomImage(
                        image: '${campaignController.basicCampaignList![itemIndex].imageFullUrl}', height: 80, width: double.infinity,
                      ),
                    ),
                  ),
                );
            ...
            Row(
              ...
              children: campaignController.basicCampaignList!.map((bnr) {
                final int index = campaignController.basicCampaignList!.indexOf(bnr);
