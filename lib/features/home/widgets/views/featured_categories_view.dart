    ...
    return GetBuilder<ItemController>(
      builder: (itemController) {
        ...
        if(itemController.featuredCategoriesItem != null) {
          for(final Categories category in itemController.featuredCategoriesItem!.categories!) {
            categoryList.add(category);
          }

          for (final Item product in itemController.featuredCategoriesItem!.items!) {
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final bool isSelected = itemController.selectedCategory == index;
                        final double width = double.parse(categoryList[index].name!.length.toString()) * 5;
