...
class _FlashSaleCardState extends State<FlashSaleCard> {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
        AspectRatio(
          aspectRatio: ResponsiveHelper.isMobile(context) ? 2.5 : ResponsiveHelper.isDesktop(context) ? 2 : 1.6,
  ...
  Widget carouselCard(int index, ActiveProducts activeProduct) {
    final double? discount = activeProduct.item!.storeDiscount == 0 ? activeProduct.item!.discount : activeProduct.item!.storeDiscount;
    final String? discountType = activeProduct.item!.storeDiscount == 0 ? activeProduct.item!.discountType : 'percent';
    return Column(children: [
        Expanded(
          child: Padding(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: CustomImage(
                              ...
                              fallbackUrls: activeProduct.item!.imagesFullUrl,
                              imageStatus: activeProduct.item!.imageStatus,
                          ...
                          OrganicTag(item: activeProduct.item!),
