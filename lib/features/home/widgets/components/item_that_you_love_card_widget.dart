      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: ResponsiveHelper.isMobile(context)
              ? [BoxShadow(color: Colors.grey.withValues(alpha: 0.1), spreadRadius: 1, blurRadius: 5, offset: const Offset(0, 1))]
              : null,
        ),
        child: CustomInkWell(
                      ...
                      children: [
                        ...
                        Wrap(alignment: WrapAlignment.center, crossAxisAlignment: WrapCrossAlignment.center, children: [
                          item.discount != null && item.discount! > 0
                              ? PriceConverter.convertPrice2(Get.find<ItemController>().getStartingPrice(item),
