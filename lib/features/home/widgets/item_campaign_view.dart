                ...
                SizedBox(
                  ...
                  child: campaignController.itemCampaignList != null
                      ? ListView.builder(
                          ...
                          itemCount:
                              campaignController.itemCampaignList!.length > 10 ? 10 : campaignController.itemCampaignList!.length,
                              ...
                              child: InkWell(
                                onTap: () {
                                  Get.find<ItemController>()
                                      .navigateToItemPage(campaignController.itemCampaignList![index], context, isCampaign: true);
                                },
                                child: Container(
                                  height: 150,
                                  width: 130,
          ...
          child: Shimmer(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(
                ...
                width: 130,
                decoration: BoxDecoration(
                    borderRadius: const BorderRadius.vertical(top: Radius.circular(Dimensions.radiusSmall)), color: Colors.grey[300]),
              ),
              Expanded(
                child: Padding(
