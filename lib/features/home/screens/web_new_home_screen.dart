...
class _WebNewHomeScreenState extends State<WebNewHomeScreen> {
  ...
  void initState() {
    super.initState();
    appLogger.logPageEntry('WebNewHomeScreen');
    appLogger.info('🏠 WebNewHomeScreen: Initializing');
  ...
  Widget build(BuildContext context) {
    ...
    final bool isFood = Get.find<SplashController>().module != null &&
        Get.find<SplashController>().module!.moduleType.toString() ==
            AppConstants.food;
    final bool isShop = Get.find<SplashController>().module != null &&
        Get.find<SplashController>().module!.moduleType.toString() ==
                            ...
                            children: [
                              ...
                              GetBuilder<StoreController>(
                                ...
                                return GetBuilder<FlashSaleController>(
                                  ...
                                  final bool isFlashSaleActive = (flashController
              ...
              return FooterView(
                child: SizedBox(
                  ...
                  child: PaginatedListView(
                    ...
                    onPaginate: (int? offset) async => await storeController
                        .getStoreList(offset?.toInt() ?? 1, false),
                    itemView: ItemsView(
                      isStore: true,
                      items: null,
