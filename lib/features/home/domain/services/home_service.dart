...
class HomeService implements HomeServiceInterface {
  ...
  Future<List<CashBackModel>> getCashBackOfferList() async {
    final result = await homeRepositoryInterface.getList();
    return result is List<CashBackModel>? ? (result ?? []) : [];
  }
  ...
  @override
  Future<BusinessSettingsModel?> getBusiness_Settings() {
    return homeRepositoryInterface.getBusiness_Settings();
  }
}
