...
class NotificationBodyModel {
  ...
  NotificationBodyModel.fromJson(Map<String, dynamic> json) {
    notificationType = convertToEnum(json['order_notification']?.toString());
    orderId = json.parseInt('order_id');
    adminId = json.parseInt('admin_id');
    deliverymanId = json.parseInt('deliveryman_id');
    restaurantId = json.parseInt('restaurant_id');
