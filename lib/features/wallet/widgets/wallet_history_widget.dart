  ...
  Widget build(BuildContext context) {
    return GetBuilder<WalletController>(builder: (walletController) {
      if (kDebugMode) {
        ...
        debugPrint('   - walletController.transactionList: ${walletController.transactionList != null ? "NOT NULL" : "NULL"}');
        debugPrint('   - walletController.transactionList.length: ${walletController.transactionList?.length ?? 0}');
        debugPrint('   - walletController.transactionList.isEmpty: ${walletController.transactionList?.isEmpty ?? true}');
        debugPrint('   - walletController.isLoading: ${walletController.isLoading}');
      }
      ...
      return Column(children: [
        Padding(
          padding: EdgeInsets.only(
              top: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeExtraSmall : Dimensions.paddingSizeExtraLarge),
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            PopupMenuButton<dynamic>(
              ...
              onSelected: (dynamic value) {
                walletController.setWalletFilerType(walletController.walletFilterList[value as int].value!);
              ...
              child: Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(
                      left: Dimensions.paddingSizeSmall, right: Dimensions.paddingSizeExtraSmall, top: 2, bottom: 2),
                  child: Row(children: [
                    Text(
                      'filter'.tr,
                ...
                ? GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (kDebugMode && index == 0) {
                        debugPrint('🔍 [WalletHistoryWidget] Building transaction item $index of ${walletController.transactionList!.length}');
                      }
