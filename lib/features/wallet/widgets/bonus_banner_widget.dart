    ...
    return GetBuilder<WalletController>(builder: (walletController) {
      return walletController.fundBonusList != null &&
          ...
          ? Column(
              ...
              children: [
                SizedBox(
                  height: ResponsiveHelper.isDesktop(context) ? 110 : 130,
                                      ...
                                      child: Wrap(
                                        ...
                                        children: [
                                          ...
                                          PriceConverter.convertPrice2(
                                            walletController.fundBonusList![index].minimumAddAmount,
                ...
                Row(
                  ...
                  children: walletController.fundBonusList!.map((bnr) {
                    final int index = walletController.fundBonusList!.indexOf(bnr);
