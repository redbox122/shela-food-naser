...
class Result {
  ...
  Result.fromJson(Map<String, dynamic> json) {
    if (json['address_components'] != null) {
      addressComponents = [];
      for (var v in (json['address_components'] as List)) {
    ...
    if (json['photos'] != null) {
      photos = [];
      for (var v in (json['photos'] as List)) {
        photos!.add(Photos.fromJson(v as Map<String, dynamic>));
      }
    }
    placeId = json['place_id']?.toString();
    reference = json['reference']?.toString();
    types = json['types'] != null ? (json['types'] as List).map((e) => e.toString()).toList() : null;
    url = json['url']?.toString();
    utcOffset = json.parseInt('utc_offset');
...
class Photos {
  ...
  Photos.fromJson(Map<String, dynamic> json) {
    height = json.parseInt('height');
    htmlAttributions = json['html_attributions'] != null ? (json['html_attributions'] as List).map((e) => e.toString()).toList() : [];
    photoReference = json.parseString('photo_reference');
    width = json.parseInt('width');
  }
