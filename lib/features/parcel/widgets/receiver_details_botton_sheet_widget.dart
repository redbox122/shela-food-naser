        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          CustomButton(
            ...
            onPressed: () {
              ...
              final String streetNumber = _streetNumberController.text.trim();
              ...
              if(name.isEmpty) {
                ...
                final AddressModel address = Get.find<ParcelController>().destinationAddress!;
                ...
                final AddressModel pickedAddress = Get.find<ParcelController>().pickupAddress!;
