...
abstract class KaidhaSubRepositoryInterface {
  //

  Future<bool> Stor_info(context, KaidhaSubModel kaidhaSub, List<NamedFile> list_img);
  ...
  Future<Response> Nafath_send_cancel(BuildContext context, String nationalId);
  Future<NafathRandomModel?> Nafath_send_retry(
      BuildContext context, String nationalId);

  Future<Response> Nafath_send_All_Data(BuildContext context, String national_id, String city, String neighborhood, String house_type, KaidhaSubModel kaidhaSub, List<NamedFile> list_img);

  Future<Response> SendState_kaidha(int user_id, String status, Map<String, dynamic> data);
