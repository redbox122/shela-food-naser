...
List<String> generateContractIntro({
  ...
  return [
    ...
    'بين كل من:',
    'الطرف الأول: شركة "شله" (المشار إليها فيما بعد بـ "الشركة")، وهي مؤسسة تجارية مسجلة وفقًا لقوانين المملكة العربية السعودية وعنوانها الرياض، مجمع السن فالي، وتعمل كمقدمة لخدمة "قيدها - اشتر الآن وادفع مع الراتب".',
    '',
    ...
    'خدمة قيدها - اشتر الآن وادفع مع الراتب هي خدمة بيع بالآجل قصيرة الأجل تقدم عبر تطبيق "شله" تتيح للعميل المؤهل شراء المنتجات والخدمات من المتاجر المؤهلة المدرجة في التطبيق، ودفع قيمتها لاحقًا في الموعد المحدد وفقًا لبنود هذا العقد، وذلك دون فرض أي فوائد أو رسوم إدارية أو رسوم تأخير أو أي رسوم إضافية أخرى على العميل مقابل استخدام الخدمة نفسها.',
    ...
    '1. يلتزم العميل بتقديم طلب تفعيل الخدمة عبر تطبيق "شله"، وتعبئة كافة البيانات المطلوبة بشكل صحيح ودقيق، والموافقة على شروط وأحكام هذا العقد وسياسة الخصوصية.',
    ...
    '1. يمكن للعميل استخدام الخدمة للشراء من المتاجر المؤهلة التي تظهر قائمتها في تطبيق "شله".',
    ...
    'المادة السادسة: عملية الشراء والدفع',
    '1. يتم إجراء عمليات الشراء باستخدام الخدمة عبر تطبيق "شله" لدى المتاجر المؤهلة.',
    '2. يتم تسجيل جميع عمليات الشراء وتفاصيلها (المنتج، الخدمة، القيمة، التاريخ، الوقت، المتجر) في حساب العميل بالتطبيق.',
    '3. يعتبر إدخال العميل لرمز التحقق لمرة واحدة (OTP) الخاص بعملية التسليم، أو تأكيد الاستلام عبر الإشعارات الواردة في تطبيق "شله"، بمثابة إثبات قاطع ونهائي لاستلام العميل للمنتجات أو الخدمات المشتراة، ولا يعتد بأي إنكار للاستلام بعد ذلك.',
    ...
    'المادة الحادية عشرة: مسؤوليات الشركة',
    '1. تلتزم الشركة بتوفير خدمة آمنة وفعالة للعميل عبر تطبيق "شله".',
    ...
    '2. سياسة الخصوصية يقر العميل باطلاعه و موافقته على سياسة الخصوصية الخاصة بشركة "شله" والمتاحة على الموقع الإلكتروني والتطبيق، والتي تعتبر جزءا لا يتجزأ من هذا العقد.',
    ...
    '7. الإشعارات تعتبر الإشعارات المرسلة عبر تطبيق "شله" أو الرسائل النصية SMS أو البريد الإلكتروني أو تطبيق واتساب على العناوين والأرقام المسجلة من قبل العميل بمثابة إشعارات رسمية ومنتجة لآثارها القانونية.',
    '',
    'إقرار وتوقيع',
