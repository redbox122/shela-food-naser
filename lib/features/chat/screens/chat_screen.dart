                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Container(
                                          ...
                                          children: [
                                                ...
                                                ? Container(
                                                    ...
                                                    child: Row(children: [
                                                      ...
                                                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                        ...
                                                        (chatController.messageModel != null &&
                                                                chatController.messageModel!.conversation!.receiver!.phone != null)
                                                            ? Text(
                                            ...
                                            (chatController.messageModel != null &&
                                                    (chatController.messageModel!.status! ||
                                                        chatController.messageModel!.messages!.isEmpty))
                                                ? Container(
                                                    padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                                                    decoration: BoxDecoration(
                                                      borderRadius: const BorderRadius.all(Radius.circular(Dimensions.radiusDefault)),
                                                      border:
                                                          Border.all(color: Theme.of(context).disabledColor.withValues(alpha: 0.6)),
                                                      color: Theme.of(context).cardColor,
                                                    ),
                                                                                ...
                                                                                Positioned(
                                                                                  ...
                                                                                  child: InkWell(
                                                                                    onTap: () => chatController.removeImage(
                                                                                        index, _inputMessageController.text.trim()),
                                                                                    child: Container(
                                                                                      decoration: const BoxDecoration(
                                        ...
                                        child: VerticalDivider(width: 0, thickness: 1, color: Theme.of(context).hintColor),
                                                        ...
                                                        GetBuilder<ChatController>(builder: (chatController) {
                                                          final bool showMessageSuggestion = (widget.orderChatModel != null &&
                                                                    ...
                                                                    if (showMessageSuggestion) {
                                                                      if (ResponsiveHelper.isDesktop(context)) {
                                                                        Get.dialog(const MessageSuggestionWidget(),
                                                                            ...
                                                                            .then((value) async {
                                                                          if (value != null) {
                                                                            _inputMessageController.text = value as String;
                                                                        ...
                                                                        Get.bottomSheet(
                                                                                const SupportReasonBottomSheet(
                                                                                    orderId: null, fromChatPage: true),
                                            ...
                                            return chatController.isLoading
                                                ...
                                                : InkWell(
                                                    onTap: () async {
                                                      if (showMessageSuggestion) {
                                                        if (ResponsiveHelper.isDesktop(context)) {
                                                          Get.dialog(const MessageSuggestionWidget(), barrierColor: Colors.transparent)
                                                              .then((value) async {
                                                            if (value != null) {
                                                              _inputMessageController.text = value as String;
                                                              chatController.toggleSendButtonActivity();
                          ...
                          children: [
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Padding(
                                ...
                                child: Text('choose_the_reason_for_support'.tr,
                                      ...
                                      child: TextHover(builder: (isHovered) {
                                        return Container(
                                          decoration: BoxDecoration(
                                            ...
                                            border:
                                                Border.all(color: Theme.of(context).disabledColor.withValues(alpha: 0.5), width: 0.3),
                                            boxShadow: isHovered
                                                ? [
                                                    BoxShadow(
                                                        color: Theme.of(context).disabledColor.withValues(alpha: 0.5), blurRadius: 10)
                                                  ]
                                                : null,
                                          ),
                                          padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                                          margin: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                                          child: Text(orderController.supportReasons![index] ?? '',
                                              style: isHovered ? robotoMedium : robotoRegular),
                                        );
                                      }),
                                    );
                                  }),
