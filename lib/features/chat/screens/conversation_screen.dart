...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  void initCall() {
    if (AuthHelper.isLoggedIn()) {
      ...
      Get.find<ChatController>().getConversationList(1, type: Get.context != null && ResponsiveHelper.isDesktop(Get.context!) ? 'vendor1' : '');
    }
  }
    ...
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        ...
        floatingActionButton:
            (chatController.conversationModel != null && !chatController.hasAdmin) && !ResponsiveHelper.isDesktop(context)
