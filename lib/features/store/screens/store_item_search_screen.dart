...
import 'package:sixam_mart/features/store/widgets/store_search_Filter_widget.dart';
      ...
      return Scaffold(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          storeController.set_Price_store_Search(!storeController.isPriceAscending);
                        },
                        child: Container(
                          ...
                          child: Icon(
                              storeController.isPriceAscending
                                  ? Icons.trending_down // يوحي بسعر يصعد
                                  : Icons.trending_up, // يوحي بسعر ينخفض
                              size: 28,
                      ...
                      IconButton(
                          ...
                          onPressed: () {
                            ...
                            //     .getStoreSearchItemList("ا", widget.storeID, 1, Get.find<StoreController>().searchType);
                          }),
          ...
          body: Column(
            children: [
              ...
              //         category: storeController.categoryList![index],
              //         onTap: () {
