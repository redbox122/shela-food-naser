  ...
  Widget build(BuildContext context) {
    return GetBuilder<FlashSaleController>(builder: (flashSaleController) {
      ...
      if (flashSaleController.flashSaleModel != null && flashSaleController.flashSaleModel!.activeProducts != null) {
        final int index = flashSaleController.flashSaleModel!.activeProducts!.length > 1 ? flashSaleController.pageIndex : 0;
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: FittedBox(
                          child: CustomInkWell(
                            onTap: () => Get.toNamed(RouteHelper.getFlashSaleDetailsScreen(
                                flashSaleController.flashSaleModel!.activeProducts![0].flashSaleId!)),
                      ...
                      SizedBox(
                        ...
                        child: Text('${item!.name}',
                            style: robotoRegular, maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
                      ),
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        child: Stack(
                          children: [
                            Builder(builder: (context) {
                              final bool bothZero = remaining == 0 && stock == 0;
