...
class FlashProductCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double? discount = product.item!.storeDiscount == 0 ? product.item!.discount : product.item!.storeDiscount;
    final String? discountType = product.item!.storeDiscount == 0 ? product.item!.discountType : 'percent';
              ...
              child: Column(
                ...
                children: [
                  Text(product.item!.name ?? '',
                      maxLines: 2, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: robotoMedium),
                  ...
                  Wrap(children: [
                    product.item!.discount != null && product.item!.discount! > 0
                        ...
                        : const SizedBox(),
                    SizedBox(
                        width: product.item!.discount != null && product.item!.discount! > 0 ? Dimensions.paddingSizeExtraSmall : 0),
                    PriceConverter.convertPrice2(
                      Get.find<ItemController>().getStartingPrice(product.item!),
                      discount: product.item!.discount,
                      discountType: product.item!.discountType,
                      ...
                      !ResponsiveHelper.isDesktop(context)
                          ? Positioned(
                              ...
                              child: Text(
                                '${'sold'.tr} $sold/$stock',
                                style:
                                    robotoMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).cardColor),
