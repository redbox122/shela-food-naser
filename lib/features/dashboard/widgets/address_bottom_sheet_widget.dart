  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: GetBuilder<AddressController>(builder: (addressController) {
        final AddressModel? selectedAddress = AddressHelper.getUserAddressFromSharedPref();
          ...
          Flexible(
            child: SingleChildScrollView(
              padding: EdgeInsets.symmetric(
                  horizontal: fromDialog ? 50 : Dimensions.paddingSizeLarge, vertical: Dimensions.paddingSizeSmall),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                ...
                (addressController.addressList != null && fromDialog)
                    ...
                    : const SizedBox(),
                Align(
                  alignment: addressController.addressList != null && addressController.addressList!.isEmpty && !fromDialog
                      ? Alignment.center
                      : Alignment.topCenter,
                    ...
                    onPressed: () {
                      Get.find<LocationController>().checkPermission(() async {
                        ...
                        final ZoneResponseModel response =
                            await Get.find<LocationController>().getZone(address.latitude, address.longitude, false);
                        if (!context.mounted) {
                          return;
                        }
                ...
                SizedBox(
                    height: addressController.addressList != null && addressController.addressList!.isEmpty
                        ? 0
