              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Align(child: Text('payment_method'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge))),
                    const SizedBox(height: Dimensions.paddingSizeLarge),
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          final bool isSelected = businessController.paymentIndex == 1 && Get.find<SplashController>().configModel!.activePaymentMethodList![index].getWay! == businessController.digitalPaymentName;
