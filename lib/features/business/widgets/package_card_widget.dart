...
class PackageCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final StoreRegistrationController storeRegController = Get.find<StoreRegistrationController>();

    final bool isRental = storeRegController.moduleList != null &&
          ...
          child: Column(children: [
            Text(
              ...
              style: robotoBold.copyWith(
                  fontSize: Dimensions.fontSizeLarge, color: canSelect ? Theme.of(context).cardColor : Colors.cyan.shade700),
            ),
            ...
            PriceConverter.convertPrice2(
              ...
              textStyle: robotoBold.copyWith(
                fontSize: 35,
                color: canSelect ? Theme.of(context).cardColor : Colors.cyan.shade700,
              ),
            ),
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              PackageWidget(
                  title: '${isRental ? 'max_trip'.tr : 'max_order'.tr} (${packages.maxOrder})', isSelect: canSelect ? true : false),
              PackageWidget(
                  title: '${isRental ? 'max_vehicle'.tr : 'max_product'.tr} (${packages.maxProduct})',
              ...
              packages.selfDelivery == 1
                  ? PackageWidget(title: 'self_delivery'.tr, isSelect: canSelect ? true : false)
                  : const SizedBox(),
            ]),
          ]),
        ),
