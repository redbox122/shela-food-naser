...
abstract class CheckoutRepositoryInterface extends RepositoryInterface {
  ...
  Future<Response> getDistanceInMeterNew(LatLng originLatLng, LatLng destinationLatLng);
  ...
  Future<Response> processPayment(int orderId, String paymentMethod, double amount);
  Future<Response> editOrderAddress(int orderId, String address, String latitude, String longitude);
}
