      ...
      child: SizedBox(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(
            ...
            child: Text(
              isPartialPay
                  ? 'you_do_not_have_sufficient_balance_to_pay_full_amount_via_wallet'.tr
          ...
          Padding(
            ...
            child: isPartialPay
                ...
                : PriceConverter.convertPrice2(
                    Get.find<ProfileController>().userInfoModel!.walletBalance! - totalPrice,
                    prefixText: '${'remaining_wallet_balance'.tr}: ',
                    textStyle: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
                  ),
          ),
          Padding(
