          ...
          (!widget.takeAway && Get.find<SplashController>().configModel!.dmTipsStatus == 1)
              ? Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  title: AppConstants.tips[index] == '0'
                                      ...
                                      : (index != AppConstants.tips.length - 1)
                                          ? PriceConverter.convertPrice2(
                                              double.parse(AppConstants.tips[index].toString()),
                                            ).toString()
                    ...
                    SizedBox(
                        height:
                            (checkoutController.selectedTips == AppConstants.tips.length - 1) && checkoutController.canShowTipsField
                    ...
                    SizedBox(
                        height: checkoutController.selectedTips == AppConstants.tips.length - 1 ? Dimensions.paddingSizeDefault : 0),
                    checkoutController.selectedTips == AppConstants.tips.length - 1
                        ? Row(children: [
                            Expanded(
