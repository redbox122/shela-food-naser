                                ...
                                onPressed: () {
                                  if ((((maxCodOrderAmount != null && orderAmount! < maxCodOrderAmount!) ||
                                    ...
                                    orderController.switchToCOD(orderID, guestId: guestId.isNotEmpty ? guestId : null).then((success) {
                                      if (success) {
                                        final double total = ((orderAmount! / 100) *
                                    ...
                                    showCustomSnackBar(
                                        '${'you_cant_order_more_then'.tr} ${PriceConverter.convertPrice2(maxCodOrderAmount, textStyle: robotoMedium)} ${'in_cash_on_delivery'.tr}');
                                  }
                                },
                        ...
                        TextButton(
                          onPressed: () {
                            Get.find<OrderController>()
                                .cancelOrder(int.parse(orderID!), 'Digital payment issue',
