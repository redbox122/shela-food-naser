            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: Theme.of(context).primaryColor.withValues(alpha: 0.1), blurRadius: 5, spreadRadius: 1)
                    ],
                  ),
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text(
                      ...
                      style: robotoMedium.copyWith(
                          fontSize: ResponsiveHelper.isDesktop(context) ? Dimensions.fontSizeDefault : Dimensions.fontSizeExtraLarge),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              Get.find<SplashController>().configModel!.customerWalletStatus == 1
                  ? Expanded(
                      ...
                      image: Images.walletProfile,
                      data: PriceConverter.convertPrice2(profileController.userInfoModel!.walletBalance).toString(),
                      title: 'wallet_balance'.tr,
                    ))
                  : const SizedBox(),
              SizedBox(
                  width: Get.find<SplashController>().configModel!.customerWalletStatus == 1 ? Dimensions.paddingSizeExtremeLarge : 0),
