...
class RegistrationStepper extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color color = onGoing ? Theme.of(context).primaryColor : isActive ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withValues(alpha: 0.7);
    final Color right = onGoing ? Theme.of(context).disabledColor.withValues(alpha: 0.7) : rightActive ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withValues(alpha: 0.7);
    return Expanded(
