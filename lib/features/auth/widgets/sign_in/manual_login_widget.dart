...
class ManualLoginWidget extends StatelessWidget {
  ...
  final VoidCallback onClickLoginButton;
  final VoidCallback? onWebSubmit;
    ...
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          InkWell(
            onTap: authController.isLoading
                ...
                : () {
                    // 🔧 FIX: Use void generic type to prevent type mismatch with GetX routes
                    Get.toNamed<void>(RouteHelper.getSignUpRoute());
                  },
            child: Padding(
        ...
        onOtpViewClick != null
            ...
            : const SizedBox(),
        socialEnable ? const SocialLoginWidget() : const SizedBox(),
      ]);
    });
  }

  Widget webView(bool isDesktop, BuildContext context, AuthController authController) {
    final bool onlyManualLoginEnable = onOtpViewClick == null && !socialEnable;
    return Padding(
            ...
            ? Center(
                child: Padding(
                  padding: const EdgeInsets.symmetric(
                      horizontal: Dimensions.paddingSizeExtraOverLarge, vertical: Dimensions.paddingSizeLarge),
                  child: RotatedBox(
                    quarterTurns: 3,
                    child: Row(
