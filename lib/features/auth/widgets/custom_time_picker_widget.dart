...
class CustomTimePickerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> unit = ['minute', 'hours', 'days'];
      ...
      child: Container(
        ...
        child: GetBuilder<StoreRegistrationController>(builder: (storeRegController) {
          return Column(
            ...
            children: [
              Text(isRental ? 'estimated_pickup_time_time'.tr : 'estimated_delivery_time'.tr,
              ...
              CustomButton(
                ...
                onPressed: () {
                  ...
                  if (min == null) {
                    showCustomSnackBar(
                        isRental ? 'minimum_pickup_time_can_not_be_empty' : 'minimum_delivery_time_can_not_be_empty'.tr);
                  } else if (max == null) {
                    showCustomSnackBar(
                        isRental ? 'maximum_pickup_time_can_not_be_empty' : 'maximum_delivery_time_can_not_be_empty'.tr);
                  } else if (storeRegController.storeTimeUnit.isEmpty) {
                    showCustomSnackBar('time_unit_can_not_be_empty'.tr);
                  } else if (min < max) {
                    Get.back();
                  } else {
                    showCustomSnackBar(isRental
