      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        GetBuilder<StoreController>(builder: (storeController) {
          ...
          if(storeController.cartSuggestItemModel != null){
            ...
            for (final Item item in storeController.cartSuggestItemModel!.items!) {
                  ...
                  SizedBox(
                    ...
                    child: PageView.builder (
                      ...
                      itemBuilder: (context, index) {
                        final int index1 = index * 4;
                        final int index2 = (index * 4) + 1;
                        final int index3 = (index * 4) + 2;
                        final int index4 = (index * 4) + 3;
                        final bool hasSecond = index2 < suggestedItems!.length;
                        final bool hasThird = index3 < suggestedItems.length;
                        final bool hasFourth = index4 < suggestedItems.length;
                        return Stack(
                          children: [
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ItemWidget(
                                      ...
                                      store: null, index: index, length: null, inStore: true,
                                    ),
                                ),
