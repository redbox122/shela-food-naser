...
abstract class CartServiceInterface {
  ...
  Future<List<online_cart.OnlineCartModel>?> getCartDataOnline();
  ...
  Future<List<online_cart.OnlineCartModel>?> updateCartOnline(OnlineCart cart);
  Future<List<online_cart.OnlineCartModel>?> addToCartOnline(OnlineCart cart);
