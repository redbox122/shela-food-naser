...
class MenuButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final int count = ResponsiveHelper.isDesktop(context)
        ? 8
        : ResponsiveHelper.isMobile(context)
            ? 6
            : 4;
    final double size =
        ((context.width > Dimensions.webMaxWidth ? Dimensions.webMaxWidth : context.width) / count) - Dimensions.paddingSizeDefault;
...
class ProfileImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProfileController>(builder: (profileController) {
      ...
      final String? imageUrl = profileController.userInfoModel != null && 
                               isLoggedIn && 
                               profileController.userInfoModel!.imageFullUrl != null &&
                               profileController.userInfoModel!.imageFullUrl!.isNotEmpty
