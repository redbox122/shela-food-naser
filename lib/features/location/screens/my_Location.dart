...
class My_Location_Screen extends StatefulWidget {
  ...
  @override
  State<My_Location_Screen> createState() => _My_Location_ScreenState();
}

class _My_Location_ScreenState extends State<My_Location_Screen> {
  ...
  void initState() {
    ...
    // Fetch zone polygons for visual display (deferred to avoid setState during build)
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<LocationController>().fetchZonePolygons();
    });
          ...
          return ResponsiveHelper.isDesktop(context)
                        ...
                        child: Stack(children: [
                          ...
                          Positioned(
                            ...
                            child: FloatingActionButton(
                              ...
                              heroTag: 'my_location_confirm_fab_1',
                              mini: true,
              ...
              : Stack(children: [
                  ...
                  Positioned(
                    ...
                    child: FloatingActionButton(
                      // 🔥 FIX: Add unique heroTag to prevent "multiple heroes" error
                      heroTag: 'my_location_confirm_fab_2',
                      mini: true,
                      backgroundColor: Theme.of(context).cardColor,
                      onPressed: () =>
