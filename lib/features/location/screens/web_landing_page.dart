...
class _WebLandingPageState extends State<WebLandingPage> {
              ...
              child: GetBuilder<SplashController>(builder: (splashController) {
                return splashController.landingModel == null
                    ...
                    : Column(children: [
                          ...
                          child: Row(children: [
                            ...
                            Expanded(
                                child: Column(
                                    ...
                                    children: [
                                  Text(splashController.landingModel?.fixedHeaderTitle ?? '',
                                    ...
                                    child: Row(children: [
                                      Expanded(
                                        ...
                                        textFieldConfiguration: TextFieldConfiguration(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            border: OutlineInputBorder(
                                              ...
                                              borderSide:
                                                  BorderSide(color: Theme.of(context).primaryColor.withValues(alpha: 0.3)),
                                            ),
                                        ...
                                        onSuggestionSelected: (PredictionModel suggestion) async {
                                          ...
                                          _address = await Get.find<LocationController>()
                                      ...
                                      CustomButton(
                                        ...
                                        onPressed: () async {
                                          if (_address != null && _controller.text.trim().isNotEmpty) {
                                            Get.dialog(const CustomLoaderWidget(), barrierDismissible: false);
                                            final ZoneResponseModel response = await Get.find<LocationController>().getZone(
                                              _address!.latitude,
                                              _address!.longitude,
                                              false,
                                            );
                                            ...
                                            if (response.isSuccess) {
                                              ...
                                              debugPrint(
                                                  "\x1B[32m  /555555555  ${'service_not_available_in_current_location'.tr}  \x1B[0m");
                                              showCustomSnackBar('service_not_available_in_current_location'.tr);
                                            }
                                          } else {
                                            debugPrint("\x1B[32m  /555555555555555  ${'pick_an_address'.tr}  \x1B[0m");
                                  ...
                                  child: Stack(children: [
                                    PageView.builder(
                                      ...
                                      onPageChanged: (int index) =>
                                          splashController.setModuleIndex(index >= splashController.moduleList!.length ? 0 : index),
                                      itemBuilder: (context, index) {
                                        index = splashController.moduleIndex >= splashController.moduleList!.length
                                            ? 0
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: Column(children: [
                                                      ...
                                                      SizedBox(
                                                          width: 45,
                                                          child: Divider(
                                                            color: splashController.moduleIndex == index
                        ...
                        const SizedBox(height: 40),
                        (splashController.landingModel?.availableZoneStatus == 1 &&
                                splashController.landingModel!.availableZoneList!.isNotEmpty)
                            ? Row(children: [
                                Expanded(
                                  flex: 2,
                                  child: CustomImage(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      Expanded(
                                        child: SingleChildScrollView(
                                          child: Wrap(
                                            children:
                                                List.generate(splashController.landingModel?.availableZoneList?.length ?? 0, (index) {
                                              final modules = splashController.landingModel?.availableZoneList?[index].modules ?? [];
                                              final modulesText = modules.join(', ');
                                                  ...
                                                  child: CustomToolTip(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        ...
                                                        boxShadow: splashController.hoverStates[index]
                                                      ...
                                                      child: Text(
                                                        ...
                                                        style: robotoBold.copyWith(
                                                            color: splashController.hoverStates[index]
                                                                ? Theme.of(context).primaryColor
                            ...
                            : const SizedBox(),
                        SizedBox(
                            height: (splashController.landingModel?.availableZoneStatus == 1 &&
                                    splashController.landingModel!.availableZoneList!.isNotEmpty)
                                ? 40
                                : 0),
                        ...
                        splashController.landingModel?.joinSellerStatus == 1
                            ...
                            : const SizedBox(),
                        SizedBox(
                            height: splashController.landingModel != null && splashController.landingModel!.joinSellerStatus == 1
                                ? 40
                                : 0),
                        splashController.landingModel != null &&
                                ...
                                Column(children: [
                                  ...
                                  Row(children: [
                                    splashController.landingModel != null &&
                                        ...
                                        ? InkWell(
                                            onTap: () async {
                                              final String url = splashController.landingModel?.downloadUserAppLinks?.playstoreUrl ?? '';
                                    ...
                                    splashController.landingModel != null &&
                                        ...
                                        ? InkWell(
                                            onTap: () async {
                                              final String url = splashController.landingModel!.downloadUserAppLinks!.appleStoreUrl ?? '';
                                              if (await canLaunchUrlString(url)) {
                                                launchUrlString(url);
                                              }
                                            },
                            ...
                            : const SizedBox(),
                        const SizedBox(height: 40),
                        splashController.landingModel?.joinDeliveryManStatus == 1
  ...
  List<Widget> _generateChooseUsList(SplashController splashController) {
    final List<Widget> chooseUsList = [];
    for (int index = 0;
        index <
