    ...
    return Stack(children: [
      ...
      Column(
        ...
        children: [
                  ...
                  height: DateConverter.isBeforeTime(order.scheduleAt) &&
                      ...
                      : parcel ||
                              ...
                              (orderController.orderDetails!.isNotEmpty &&
                                  orderController.orderDetails![0].itemDetails!.moduleType == 'grocery') ||
                              (orderController.orderDetails!.isNotEmpty &&
                                  orderController.orderDetails![0].itemDetails!.moduleType == 'ecommerce') ||
                              (orderController.orderDetails!.isNotEmpty &&
                                  orderController.orderDetails![0].itemDetails!.moduleType == 'pharmacy')
                          ? 140
                          : 0)
              : const SizedBox(),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Text(
                  order.orderType == 'delivery' ? 'توصيل' : 'المتجر',
                  style: robotoMedium,
                ),
              ]),
              ...
              order.orderStatus == 'canceled'
                  ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      InkWell(
                        onTap: () => Get.dialog(
                            ReviewDialogWidget(review: ReviewModel(comment: order.cancellationReason), fromOrderDetails: true)),
                        child: Text(
                  ...
                  ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      order.orderStatus == 'refund_requested'
                          ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              (order.refund != null && order.refund!.customerNote != null)
                                  ? InkWell(
                                      onTap: () => Get.dialog(ReviewDialogWidget(
                                          review: ReviewModel(comment: order.refund!.customerNote), fromOrderDetails: true)),
                                      child: Text(
                              ...
                              SizedBox(
                                  height:
                                      (order.refund != null && order.refund!.imageFullUrl != null) ? Dimensions.paddingSizeSmall : 0),
                                      ...
                                      onTap: () => showDialog(
                                          ...
                                          builder: (context) {
                                            return ImageDialogWidget(
                                                imageUrl:
                                                    order.refund!.imageFullUrl!.isNotEmpty ? order.refund!.imageFullUrl![0] : '');
                                          }),
                                      child: CustomImage(
                                        height: 40,
                                        width: 40,
                          ...
                          : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              InkWell(
                                onTap: () => Get.dialog(
                                    ReviewDialogWidget(review: ReviewModel(comment: order.refund!.adminNote), fromOrderDetails: true)),
                                child: Text(
          ...
          (isDesktop &&
                  (Get.find<SplashController>().getModuleConfig(order.moduleType).orderAttachment ?? false) &&
          ...
          ((Get.find<SplashController>().getModuleConfig(order.moduleType).orderAttachment ?? false) &&
              ...
              ? Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      isDesktop ? const BoxShadow(color: Colors.black12, blurRadius: 5, spreadRadius: 1) : const BoxShadow()
                    ],
                  ),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    const SizedBox(height: Dimensions.paddingSizeLarge),
                    SizedBox(
                        width: ((Get.find<SplashController>().getModuleConfig(order.moduleType).orderAttachment ?? false) &&
                                order.orderAttachmentFullUrl != null &&
                                order.orderAttachmentFullUrl!.isNotEmpty)
                    ...
                    (order.orderNote != null && order.orderNote!.isNotEmpty)
                        ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            InkWell(
                              onTap: () => Get.dialog(
                                  ReviewDialogWidget(review: ReviewModel(comment: order.orderNote), fromOrderDetails: true)),
                              child: Text(
                                order.orderNote!,
                                overflow: TextOverflow.ellipsis,
                                maxLines: 3,
          ...
          SizedBox(
              height: (Get.find<SplashController>().getModuleConfig(order.moduleType).orderAttachment ?? false) &&
                      order.orderAttachmentFullUrl != null &&
                      order.orderAttachmentFullUrl!.isNotEmpty
                  ? Dimensions.paddingSizeSmall
                  : 0),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    GridView.builder(
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        crossAxisCount: ResponsiveHelper.isMobile(context) ? 5 : 3,
                        mainAxisSpacing: 10,
                        crossAxisSpacing: 5,
                      ),
                      shrinkWrap: true,
          ...
          (!parcel && order.store != null && order.deliveryAddress != null)
              ? Container(
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor,
                    borderRadius: BorderRadius.circular(isDesktop ? Dimensions.radiusDefault : 0),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    DeliveryDetailsWidget(address_model: order.deliveryAddress!),
                  ]),
                )
              : const SizedBox(),
          ...
          isDesktop
              ? Text(
                  parcel
                      ? 'parcel_category'.tr
                      : (Get.find<SplashController>().getModuleConfig(order.moduleType).showRestaurantText ?? false)
                      ...
                      : Row(children: [
                          ...
                          (!parcel &&
                              ...
                              ? TextButton.icon(
                                  onPressed: () async {
                                    if (!parcel) {
                                      final String url = 'https://www.google.com/maps/dir/?api=1&destination=${order.store!.latitude}'
                              ...
                              order.paymentMethod == 'cash_on_delivery'
                                  ...
                                  : order.paymentMethod == 'wallet'
                                      ...
                                      : order.paymentMethod == 'partial_payment'
                                          ? 'partial_payment'.tr
                                          : order.paymentMethod == 'wallet_qidha'
                                              ? 'قيدها'
                                              : 'my_bill_wallet'.tr,
        ...
        children: [
          ...
          orderController.trackModel!.offlinePayment != null
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final Input data = orderController.trackModel!.offlinePayment!.input![index];
                    return Padding(
                      padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraSmall),
                      child: Row(children: [
