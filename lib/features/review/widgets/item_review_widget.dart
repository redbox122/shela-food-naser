                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        boxShadow: [
                          BoxShadow(
                              color: Colors.grey.withValues(alpha: 0.2), spreadRadius: 1, blurRadius: 2, offset: const Offset(0, 1))
                        ],
                      ...
                      child: Column(children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                Text(widget.orderDetailsList[index].itemDetails!.name!,
                                    style: robotoMedium, maxLines: 2, overflow: TextOverflow.ellipsis),
                                const SizedBox(height: 10),
                                PriceConverter.convertPrice2(
                                  widget.orderDetailsList[index].itemDetails!.price,
                        ...
                        MyTextField(
                          ...
                          onChanged: (text) => reviewController.setReview(index, text as String),
                        ),
