...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  void initState() {
    ...
    if (widget.address != null) {
      ...
      final String firstName = userInfo?.fName ?? '';
      final String lastName = userInfo?.lName ?? '';
      _contactPersonNameController.text =
                                          ...
                                          children: [
                                                      ...
                                                      GoogleMap(
                                                        ...
                                                        minMaxZoomPreference:
                                                            const MinMaxZoomPreference(
                                                                0, 16),
                                                        onTap: (latLng) {
                                                          if (Get.context != null && ResponsiveHelper
                                                              .isDesktop(Get
                                                                  .context!)) {
                                                          } else {
                                                            Get.toNamed(
                                                        ...
                                                        polygons:
                                                            locationController
                                                                .zonePolygons,
                                                        onCameraIdle: () async {
                                                          final CameraPosition? cameraPosition = _cameraPosition;
                                                          if (cameraPosition == null) {
                                                            return;
                                                          }
                                                          locationController.updatePosition(cameraPosition, true);
                                                        },
                                                        onCameraMove:
                                                            ((position) =>
                                                                _cameraPosition =
                                            ...
                                            SizedBox(
                                              ...
                                              child: CustomTextField(
                                                ...
                                                showTitle: true,
                                                titleText: 'delivery_address'
                                                    .tr
                                                    .toString(),
                                                hintText:
                                                    'write_delivery_address'
                                                        .tr
                                                        .toString(),
                                                inputType:
                                            ...
                                            child: ListView.builder(
                                              ...
                                              itemBuilder: (context, index) =>
                                                ...
                                                child: InkWell(
                                                  onTap: () {
                                                    debugPrint(
                                                        '\x1B[32m  /${locationController.addressTypeList[0]}  \x1B[0m');
                                          ...
                                          labelText: widget.fromRide ||
                                                  (Get.find<SplashController>()
                                                      ...
                                                      Get.find<SplashController>()
                                                              ...
                                                              .toString() ==
                                                          AppConstants.taxi)
                                              ? 'pickup_address'.tr.toString()
                                              : 'delivery_address'
                                                  .tr
                                                  .toString(),
                                          titleText: 'write_delivery_address'
                                              .tr
                                              .toString(),
                                          inputType:
                                              TextInputType.streetAddress,
  ...
  void _onSaveOrUpdateButtonPressed(
    ...
    Get.find<AddressController>().isLoading == true;
    setState(() {});
    ...
    final AddressModel? addressModel = _prepareAddressModel(
